    ...
    private Map<String, String> extractThdUrlParams(HttpServletRequest request) {
        ...
        if (null != orignalUrlParams) {
            ...
            while (entries.hasNext()) {
                ...
                /*
                 * if (key.equals(CommonCodeConstants.app_id) ||
                 * key.equals(CommonCodeConstants.api_id) ||
                 * key.equals(CommonCodeConstants.version) ||
                 * key.equals(CommonCodeConstants.app_token) ||
                 * key.equals(CommonCodeConstants.time_stamp) ||
                 * key.equals(CommonCodeConstants.sign_method) ||
                 * key.equals(CommonCodeConstants.sign) ||
                 * key.equals(CommonCodeConstants.device_token) ||
                 * key.equals(CommonCodeConstants.user_token) ||
                 * key.equals(CommonCodeConstants.format)) { continue; }
                 */
                String val = values[0];
                try {
